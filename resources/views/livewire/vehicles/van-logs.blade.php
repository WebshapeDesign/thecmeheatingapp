<div>
    ...
    <div class="flex justify-between items-center mb-6">
        <flux:heading size="xl">Van Logs: {{ $vehicle->registration_number }}</flux:heading>
    ...
    @if ($logs->count())
                                ...
                                <flux:dropdown position="bottom" align="end" offset="-15">
                                    ...
                                    <flux:menu>
                                        <flux:menu.item icon="eye">
                                            <flux:link href="{{ route('vanlogs.show', $log) }}" variant="subtle">View</flux:link>
                                        </flux:menu.item>
                                        <flux:menu.item icon="pencil">
                                            <flux:link href="{{ route('vanlogs.edit', $log) }}" variant="subtle">Edit</flux:link>
                                        </flux:menu.item>
                                    </flux:menu>
                                </flux:dropdown>
                            </flux:table.cell>
        ...
        @else
            <p class="text-gray-500 mt-6">No van logs found for this vehicle.</p>
        @endif
        </div>
        </div>
    </section>
